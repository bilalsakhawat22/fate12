...
const Buy = ({ connecctstatus, setConnectedstatus }) => {
  ...
  async function loadWeb3() {
    if (window.ethereum) {
      ...
      const contractaddress = "0x7B390A11E5C425dE7ad607234581a43ceA63eebE";
          ...
          <div className="row mx-auto text-center">
            ...
            >
              <div className="col-md-12 btngroup ">
                <h1 className="mint-heading text-center">Fate12</h1>
                ...
                <p className="text-center py-5 what_inner_text ">
                  ...
                  <button class="c-button c-button--gooey btn mint-btn"
                  onClick={async () => {
                    await connectWallet();
                    await mint();
                  }}
